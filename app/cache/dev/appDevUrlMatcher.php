...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (preg_match('#^/(?P<_locale>en|fr)/author/(?P<slug>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'blog_core_author_show')), array (  '_locale' => 'fr',  '_controller' => 'Blog\\CoreBundle\\Controller\\AuthorController::showAction',));
        }
        ...
        if (preg_match('#^/(?P<_locale>en|fr)/?$#s', $pathinfo, $matches)) {
            ...
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'blog_core_post_index')), array (  '_locale' => 'fr',  '_controller' => 'Blog\\CoreBundle\\Controller\\PostController::indexAction',));
        }

        // blog_core_post_show
        if (preg_match('#^/(?P<_locale>en|fr)/(?P<slug>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'blog_core_post_show')), array (  '_locale' => 'fr',  '_controller' => 'Blog\\CoreBundle\\Controller\\PostController::showAction',));
        }

        // blog_core_post_createcomment
        if (preg_match('#^/(?P<_locale>en|fr)/(?P<slug>[^/]++)/create\\-comment/$#s', $pathinfo, $matches)) {
            if ($this->context->getMethod() != 'POST') {
                $allow[] = 'POST';
                goto not_blog_core_post_createcomment;
            }

            return $this->mergeDefaults(array_replace($matches, array('_route' => 'blog_core_post_createcomment')), array (  '_locale' => 'fr',  '_controller' => 'Blog\\CoreBundle\\Controller\\PostController::createCommentAction',));
        }
