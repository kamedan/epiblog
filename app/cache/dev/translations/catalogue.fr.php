...
$catalogue = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'on' => 'sur',
    'by' => 'De',
    'read.more' => 'Lire suite',
    'author' => 'Auteur',
    'name' => 'nom',
    'send' => 'Envoi',
    'post.plural' => 'Posts',
    'post.latest' => 'Derniers Messages',
    'post.on' => 'Poster sur',
    'post.by' => 'Postes de',
    'post.by.author' => 'Postes de %name%',
    'post.comments' => '{0} Aucun comments | {1} %count% commentaire | ]1,Inf] %count% commentaires ',
    'comment.singular' => 'commentaire',
    'comment.plural' => 'Commentaires',
    'comment.write' => 'Ecrire votre commentaire',
  ),
));
