 ...
 */
class Comment extends \Blog\ModelBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Blog\\ModelBundle\\Entity\\Comment' . "\0" . 'id', '' . "\0" . 'Blog\\ModelBundle\\Entity\\Comment' . "\0" . 'authorName', '' . "\0" . 'Blog\\ModelBundle\\Entity\\Comment' . "\0" . 'body', '' . "\0" . 'Blog\\ModelBundle\\Entity\\Comment' . "\0" . 'post');
        }
